            ...
            <Header />
                ...
                <div className="container" style={{paddingTop:"2rem"}}>
                    ...
                    <div className="row" style={{paddingTop:"3rem"}}>
                        ...
                        <div className="col-md-7 order-md-2 " data-aos="slide-left">
                        ...
                        <div className="col-md-5 order-md-1" data-aos="slide-right">
                ...
                <div className="container">
                    <div className="row" >
                        ...
                        <div className="col-md-5 order-md-1"  data-aos="slide-left">
